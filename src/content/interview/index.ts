...
export const interviewPack: ContentPack = {
  ...
  hasLevelFilter: true,
  categories: [
    { name: 'Фронтенд', topics: ['База: переменные и значения', 'База: типы и операторы', 'База: условия и циклы', 'База: функции', 'База: массивы и объекты', 'JavaScript', 'TypeScript', 'React', 'Angular', 'Vue', 'Состояние', 'CSS и вёрстка', 'Tailwind и Sass', 'UX и доступность', 'Браузер', 'Архитектура фронта'] },
